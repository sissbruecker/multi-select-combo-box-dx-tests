...
import 'Frontend/views/updateshilla/software-update-form-solution';
import { SoftwareUpdateFormSolution } from 'Frontend/views/updateshilla/software-update-form-solution';

@customElement('updates-hilla-view-solution')
export class UpdatesHillaView extends View {
  @query('#grid')
  private grid!: Grid;
  @query('software-update-form-solution')
  private form!: SoftwareUpdateFormSolution;
    ...
    return html`
      <vaadin-split-layout>
        ...
        <div class="editor-layout">
          <div class="editor">
            <software-update-form-solution></software-update-form-solution>
          </div>
